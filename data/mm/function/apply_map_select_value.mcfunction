...
execute if score MapSelectIndex config matches 3 as @e[type=text_display,tag=map_select_display,limit=1] run data merge entity @s {text:{text:"Map: Palace",color:"yellow",bold:false}}