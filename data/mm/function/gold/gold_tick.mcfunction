...
#Airship - Drop gold every 2-4 seconds
execute if score MapSelectIndex config matches 1 if score GoldTimer gold matches 0 store result score GoldTimer gold run random value 40..80
...
#Cruise - Drop gold every 2-4 seconds
execute if score MapSelectIndex config matches 3 if score GoldTimer gold matches 0 store result score GoldTimer gold run random value 40..80
