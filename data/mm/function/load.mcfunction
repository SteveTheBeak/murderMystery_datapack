...
data modify storage mm:shop realItems set value [{tag:"mm_shop_invisibility_real",rawSlot:4,itemId:"minecraft:potion",giveFunction:"mm:shop/give_real_item",itemDef:'minecraft:potion[minecraft:custom_data={mm_shop_invisibility_real:1b},minecraft:potion_contents={custom_effects:[{id:"minecraft:invisibility",amplifier:0,duration:200,ambient:false,show_particles:false,show_icon:true}]},minecraft:custom_name={"text":"Invisibility","color":"aqua","italic":false},!minecraft:use_remainder]'},{tag:"mm_shop_speed_real",rawSlot:4,itemId:"minecraft:potion",giveFunction:"mm:shop/give_real_item",itemDef:'minecraft:potion[minecraft:custom_data={mm_shop_speed_real:1b},minecraft:potion_contents={custom_effects:[{id:"minecraft:speed",amplifier:1,duration:160,ambient:false,show_particles:false,show_icon:true}]},minecraft:custom_name={"text":"Speed","color":"aqua","italic":false},!minecraft:use_remainder]'},{tag:"mm_shop_bow_real",rawSlot:4,itemId:"minecraft:bow",giveFunction:"mm:shop/give_real_item",itemDef:'minecraft:bow[minecraft:custom_data={mm_shop_bow_real:1b},minecraft:custom_name={"text":"One-Shot Bow","color":"aqua","italic":false}]'},{tag:"mm_shop_innocent_extralife_real",rawSlot:4,itemId:"minecraft:totem_of_undying",giveFunction:"mm:shop/give_real_item",itemDef:'minecraft:totem_of_undying[minecraft:custom_data={mm_shop_innocent_extralife_real:1b},minecraft:custom_name={"text":"Extra Life","color":"aqua","italic":false}]'},{tag:"mm_shop_detective_glow_real",rawSlot:4,itemId:"minecraft:spyglass",giveFunction:"mm:shop/give_real_item",itemDef:'minecraft:spyglass[minecraft:custom_data={mm_shop_detective_glow_real:1b},minecraft:custom_name={"text":"Make Players Glow","color":"aqua","italic":false}]'},{tag:"mm_shop_freeze_real",rawSlot:4,itemId:"minecraft:ice",giveFunction:"mm:shop/give_real_item",itemDef:'minecraft:ice[minecraft:custom_data={mm_shop_freeze_real:1b},minecraft:custom_name={"text":"Freeze Murderers","color":"aqua","italic":false}]'},{tag:"mm_shop_detective_extralife_real",rawSlot:4,itemId:"minecraft:totem_of_undying",giveFunction:"mm:shop/give_real_item",itemDef:'minecraft:totem_of_undying[minecraft:custom_data={mm_shop_detective_extralife_real:1b},minecraft:custom_name={"text":"Extra Life","color":"aqua","italic":false}]'},{tag:"mm_shop_darkness_real",rawSlot:4,itemId:"minecraft:sculk_sensor",giveFunction:"mm:shop/give_real_item",itemDef:'minecraft:sculk_sensor[minecraft:custom_data={mm_shop_darkness_real:1b},minecraft:custom_name={"text":"Give Players Darkness","color":"aqua","italic":false}]'},{tag:"mm_shop_murderer_glow_real",rawSlot:4,itemId:"minecraft:sea_lantern",giveFunction:"mm:shop/give_real_item",itemDef:'minecraft:sea_lantern[minecraft:custom_data={mm_shop_murderer_glow_real:1b},minecraft:custom_name={"text":"Make Players Glow","color":"aqua","italic":false}]'},{tag:"mm_shop_rocket_real",rawSlot:4,itemId:"minecraft:crossbow",giveFunction:"mm:shop/give_real_item",itemDef:'minecraft:crossbow[minecraft:custom_data={mm_shop_rocket_real:1b},minecraft:custom_name={"text":"Rocket Launcher","color":"aqua","italic":false}]'},{tag:"mm_oneshot_arrow",rawSlot:5,itemId:"minecraft:arrow",giveFunction:"mm:shop/give_real_item",itemDef:'minecraft:arrow[minecraft:custom_data={mm_oneshot_arrow:1b}]'}]
