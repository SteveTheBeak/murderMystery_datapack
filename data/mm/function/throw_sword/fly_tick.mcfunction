...
execute as @e[tag=thrown_sword_hitbox,type=interaction] if score @s flight_time matches 5.. at @s unless block ~ ~ ~ #minecraft:replaceable run execute as @a[team=murderer] run function mm:throw_sword/give_throwable
...
execute as @e[tag=thrown_sword_hitbox,type=interaction] if score @s flight_time matches 100.. run execute as @a[team=murderer] run function mm:throw_sword/give_throwable
