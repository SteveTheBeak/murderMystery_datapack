...
execute if items entity @s weapon.mainhand *[minecraft:custom_data={mm_throw:1b}] at @s as @a[distance=..3,tag=!mm_attacker] run scoreboard players set @s HurtCheck 0