...
execute if items entity @s weapon.mainhand *[minecraft:custom_data={mm_throw:1b}] at @s as @a[distance=..3,sort=nearest,limit=1] run function mm:throw_sword/on_hit